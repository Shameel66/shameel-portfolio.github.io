...
const String aboutMeHeadline = 'I\'m Shameel Irtaza, a Mobile App developer.';

const String aboutMeDetail =
    'I\'m   Graduate as Software Engineer from NFC IET, MULTAN. I have been developing mobile apps for over 1 years now. I have worked in teams for various startups and helped them in launching their prototypes and got valuable learning experience.';
